    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return ImageCarouselModal(
          ...
          initialIndex: Configuration.backgrounds.indexOf(
            viewModel.settings.imgBackground,
          ),
      ...
      builder: (context, viewModel, child) {
        ...
        return Container(
          color: Theme.of(context).colorScheme.surface.withValues(
            alpha: Configuration.uiMidTransparency,
          ),
          child: ListView(
            children: [
              if (viewModel.versionLabel != null)
                PageSectionHeader(
                  label: viewModel.versionLabel!,
                  centerRow: true,
                ),
              // UI Settings
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Slider(
                      ...
                      divisions:
                          (Configuration.logMaxRecoveryLines -
